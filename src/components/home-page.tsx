        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-11 gap-4">
            <div className="col-span-4 p-6 pl-0">
              <h1 className="text-2xl font-medium">
                Resource Monitoring for Rollups
              </h1>
              <h2 className="text-lg mt-2">
                Get insights into the use of resources like gas, calldata and
                storage in real-time. Find the most expensive bottlenecks,
                optimise.
              </h2>
            </div>
            <TxStepsStats
          ...
          <div className="mt-28 text-center">
            <h2 className="text-4xl font-medium">
              Optimise your rollup&apos;s costs
            </h2>
            <p className="max-w-lg mx-auto mt-6">
              Find contracts that are consuming the most resources and optimise
              them. Use the flamechart to find the most expensive parts of
              transactions and optimise them.
            </p>
          </div>
